...
#include "components/themes/mindful/MindfulTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::LYRA_3_COVERS:
      ...
      break;
    case CrossPointSettings::UI_THEME::MINDFUL:
      LOG_DBG("UI", "Using Mindful theme");
      currentTheme = std::make_unique<MindfulTheme>();
      currentMetrics = &MindfulMetrics::values;
      break;
  }
}
